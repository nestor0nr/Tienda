    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ChangeUser(EditUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (model.ImageFile != null)
                {
                    //imageId = await _blobHelper.UploadBlobAsync(model.ImageFile, "users"); ----No tengo servico web, es de adaptarlo a almacenamiento local en el sistema
                    var imagenlocal = model.ImageFile;
                }
        ...
        public async Task<IActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                if (model.OldPassword== model.NewPassword) {
                    ...
                    ModelState.AddModelError(string.Empty, "Debe de ingresar una contraseña diferente.");
